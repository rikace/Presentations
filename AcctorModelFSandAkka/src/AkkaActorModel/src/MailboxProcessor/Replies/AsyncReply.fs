...
// The code example shows a mailbox processor agent that uses PostAndAsyncReply. 
// The return value of PostAndAsyncReply is an asynchronous workflow, which in this example is started by using Async.StartWithContinuations
