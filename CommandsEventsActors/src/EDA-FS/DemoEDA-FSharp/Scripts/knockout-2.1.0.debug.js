...
// Populate ko.observableArray.fn with read-only functions from native arrays
        ...
        ko.exportSymbol('jsonExpressionRewriting.bindingRewriteValProductIdators', ko.jsonExpressionRewriting.bindingRewriteValidators);
        ...
        (function() {
            ...
            ko.utils.compareArrays = function(oldArray, newArray, maxEditsToConsider) {
                if (maxEditsToConsider === undefined) {
                    return ko.utils.compareArrays(oldArray, newArray, 1)                 // First consProductIder likely case where there is at most one edit (very fast)
