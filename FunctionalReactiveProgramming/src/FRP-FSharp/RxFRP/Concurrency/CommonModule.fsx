...
module StartPhotoViewer = 
    let start() = System.Diagnostics.Process.Start(@"F:\CodeFRP\Code\FRP-FSharp\RxFRP\PhtotoViewer\PhotoViewer\bin\Release\PhotoViewer.exe")
    //System.IO.File.Exists (__SOURCE_DIRECTORY__ + @"\PhotoViewer\PhotoViewer\bin\Release\PhotoViewer.exe")
